...
describe('Shared: s3Packages', function() {
  ...
  describe('.getBucketUrlFromReleaseType()', function() {
    ...
    it('should return the production URL if given a production release type', function() {
      const bucketUrl = s3Packages.getBucketUrlFromReleaseType(information.RELEASE_TYPE.PRODUCTION);
    ...
    it('should return the snapshot URL if given a snapshot release type', function() {
      const bucketUrl = s3Packages.getBucketUrlFromReleaseType(information.RELEASE_TYPE.SNAPSHOT);
    ...
    it('should return null if given an unknown release type', function() {
      const bucketUrl = s3Packages.getBucketUrlFromReleaseType(information.RELEASE_TYPE.UNKNOWN);
  ...
  describe('.getLatestVersion()', function() {
    ...
    describe('given a valid ETCHER_FAKE_S3_LATEST_VERSION environment variable', function() {
      ...
      it('should resolve the variable', function(done) {
        s3Packages.getLatestVersion(s3Packages.BUCKET_URL.PRODUCTION).then((latestVersion) => {
